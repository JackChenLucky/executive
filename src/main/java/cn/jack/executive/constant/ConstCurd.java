package cn.jack.executive.constant;
...
public interface ConstCurd {
	 ...
	 * 定义主页转向key
	 */
	String KEY_MAIN = "/main.htm";
	
	/**
	 * 定义新增转向key
	 */
	String KEY_ADD = "/add.htm";
	
	/**
	 * 定义修改转向key
	 */
	String KEY_EDIT = "/edit.htm";
	
	/**
	 * 定义查看转向key
	 */
	String KEY_VIEW = "/view.htm";
	/**
	 * 定义首页列表key
	 */
	String KEY_LIST = "/list.htm";
